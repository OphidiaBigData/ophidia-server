...
#define soap_write_oph__ophExecuteMain(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize_oph__ophExecuteMain(soap, data), 0) || soap_put_oph__ophExecuteMain(soap, data, "oph:ophExecuteMain", NULL) || soap_end_send(soap), (soap)->error )
#endif
...
#define soap_write_oph__ophResponse(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize_oph__ophResponse(soap, data), 0) || soap_put_oph__ophResponse(soap, data, "oph:ophResponse", NULL) || soap_end_send(soap), (soap)->error )
#endif
...
#ifndef soap_write_PointerTooph__ophResponse
#define soap_write_PointerTooph__ophResponse(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize_PointerTooph__ophResponse(soap, data), 0) || soap_put_PointerTooph__ophResponse(soap, data, "oph:ophResponse", NULL) || soap_end_send(soap), (soap)->error )
#endif
...
#ifndef soap_read_PointerTooph__ophResponse
#define soap_read_PointerTooph__ophResponse(soap, data) ( ((data) ? (soap_default_PointerTooph__ophResponse(soap, (data)), 0) : 0) || soap_begin_recv(soap) || !soap_get_PointerTooph__ophResponse(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif
