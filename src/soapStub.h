...
struct oph__ophResponse;	/* oph_wsdl.h:73 */
struct oph__ophExecuteMain;	/* oph_wsdl.h:78 */
struct oph__oph_notifyResponse;	/* oph_wsdl.h:103 */
struct oph__oph_notify;	/* oph_wsdl.h:103 */

/* oph_wsdl.h:73 */
#ifndef SOAP_TYPE_oph__ophResponse
#define SOAP_TYPE_oph__ophResponse (43)
/* oph:ophResponse complex type: */
struct oph__ophResponse
{
	char *jobid;	/* SOAP 1.2 RPC return element (when namespace qualified) */	/* optional element of XSD type xsd:string */
	char *response;	/* optional element of XSD type xsd:string */
	long error;	/* required element of XSD type xsd:int */
};
#endif
...
/* oph:ophExecuteMain complex type: */
struct oph__ophExecuteMain
{
	char *ophExecuteMainRequest;	/* optional element of XSD type xsd:string */
};
#endif
