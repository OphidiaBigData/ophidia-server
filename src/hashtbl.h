...
HASHTBL *hashtbl_duplicate(HASHTBL *hashtbl); // added
void hashtbl_destroy(HASHTBL *hashtbl);
int hashtbl_insert(HASHTBL *hashtbl, const char *key, void *data);
int hashtbl_insert_with_size(HASHTBL *hashtbl, const char *key, void *data, size_t size); // added
