 ...
 * \param task_index Index of task the current task depends on. It is initialized to -1, set correctly by the function oph_workflow_indexing and reduced by deps_num (becoming negative) by the engine when the dependence is satisfied
