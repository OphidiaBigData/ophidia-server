...
#define OPH_WORKFLOW_BVAR_KEYS		{"OPH_SESSION_ID","OPH_SESSION_CODE","OPH_WORKFLOW_ID","OPH_SERVER_HOST","OPH_SERVER_PORT","OPH_USER","OPH_PASSWD"}
#define OPH_WORKFLOW_BVAR_KEYS_SIZE	7
