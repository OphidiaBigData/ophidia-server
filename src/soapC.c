...
SOAP_SOURCE_STAMP("@(#) soapC.c ver 2.8.27 2016-01-26 17:34:35 GMT")
...
{	(void)type;
	...
	case SOAP_TYPE_oph__ophExecuteMain:
		return soap_in_oph__ophExecuteMain(soap, NULL, NULL, "oph:ophExecuteMain");
	case SOAP_TYPE_oph__ophResponse:
		return soap_in_oph__ophResponse(soap, NULL, NULL, "oph:ophResponse");
	...
	case SOAP_TYPE_PointerTooph__ophResponse:
		return soap_in_PointerTooph__ophResponse(soap, NULL, NULL, "oph:ophResponse");
	...
	*type = 0;
	...
	{	const char *t = soap->type;
		...
		{	*type = SOAP_TYPE_oph__ophExecuteMain;
			return soap_in_oph__ophExecuteMain(soap, NULL, NULL, NULL);
		}
		if (!soap_match_tag(soap, t, "oph:ophResponse"))
		{	*type = SOAP_TYPE_oph__ophResponse;
			return soap_in_oph__ophResponse(soap, NULL, NULL, NULL);
		}
