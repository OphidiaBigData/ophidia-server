...
{
  if (!file || !line) pmesg_safe(&global_flag,LOG_ERROR, __FILE__,__LINE__,"");
...
void oph_child_signal_handler (int sig){ pmesg(LOG_DEBUG, __FILE__, __LINE__, "CALLED oph_signal_handler; catched signal nr %d\n", sig); }
