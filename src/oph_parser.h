...
#define OPH_OPERATOR_IO_SERVER "oph_io_server"
...
#define OPH_OPERATOR_IO_SERVER_PARAMETER_START "start"
#define OPH_OPERATOR_IO_SERVER_PARAMETER_STOP "stop"
