	...
	*jstring = NULL;
	...
	if (json->source) {
		...
		if (!source) {
			...
			if (oph_json) json_decref(oph_json);
			return OPH_JSON_MEMORY_ERROR;
		}
			...
			if (!strcmp(json->response[i].objclass,OPH_JSON_TEXT)) {
				...
				for (j = 0; j < json->response[i].objcontent_num; j++) {
					...
					if (((oph_json_obj_multigrid *) json->response[i].objcontent)[j].description) {
						if (json_object_set_new(objcontent_j,"description",json_string((const char *) ((oph_json_obj_multigrid *) json->response[i].objcontent)[j].description))) {
							pmesg_safe(flag, LOG_ERROR, __FILE__, __LINE__, OPH_JSON_LOG_MEMORY_ERROR, "description");
							if (oph_json) json_decref(oph_json);
							return OPH_JSON_MEMORY_ERROR;
						}
					...
					for (k = 0; k < ((oph_json_obj_multigrid *) json->response[i].objcontent)[j].rowvalues_num1; k++) {
						...
						for (q = 0; q < ((oph_json_obj_multigrid *) json->response[i].objcontent)[j].rowvalues_num2; q++) {
							if (json_array_append_new(rowvalues_k,json_string((const char *) ((oph_json_obj_multigrid *) json->response[i].objcontent)[j].rowvalues[k][q]))) {
								pmesg_safe(flag, LOG_ERROR, __FILE__, __LINE__, OPH_JSON_LOG_MEMORY_ERROR, "rowvalue_k");
								if (oph_json) json_decref(oph_json);
								return OPH_JSON_MEMORY_ERROR;
							}
					...
					for (k = 0; k < ((oph_json_obj_multigrid *) json->response[i].objcontent)[j].colvalues_num1; k++) {
						...
						for (q = 0; q < ((oph_json_obj_multigrid *) json->response[i].objcontent)[j].colvalues_num2; q++) {
							if (json_array_append_new(colvalues_k,json_string((const char *) ((oph_json_obj_multigrid *) json->response[i].objcontent)[j].colvalues[k][q]))) {
					...
					// MEASUREVALUES
					if (((oph_json_obj_multigrid *) json->response[i].objcontent)[j].measurevalues_num2 != ((oph_json_obj_multigrid *) json->response[i].objcontent)[j].colvalues_num1) {
						pmesg_safe(flag, LOG_ERROR, __FILE__, __LINE__, OPH_JSON_LOG_BAD_PARAM_ERROR, "measurevalues_num2");
						if (oph_json) json_decref(oph_json);
						return OPH_JSON_BAD_PARAM_ERROR;
					}
					if (((oph_json_obj_multigrid *) json->response[i].objcontent)[j].measurevalues_num1 != ((oph_json_obj_multigrid *) json->response[i].objcontent)[j].rowvalues_num1) {
					...
					for (k = 0; k < ((oph_json_obj_multigrid *) json->response[i].objcontent)[j].measurevalues_num1; k++) {
						...
						for (q = 0; q < ((oph_json_obj_multigrid *) json->response[i].objcontent)[j].measurevalues_num2; q++) {
							if (json_array_append_new(measurevalues_k,json_string((const char *) ((oph_json_obj_multigrid *) json->response[i].objcontent)[j].measurevalues[k][q]))) {
				...
				for (j = 0; j < json->response[i].objcontent_num; j++) {
					...
					if (((oph_json_obj_tree *) json->response[i].objcontent)[j].nodekeys_num != 0) {
						...
						for (k = 0; k < ((oph_json_obj_tree *) json->response[i].objcontent)[j].nodevalues_num1; k++) {
							...
							for (q = 0; q < ((oph_json_obj_tree *) json->response[i].objcontent)[j].nodevalues_num2; q++) {
								if (json_array_append_new(nodevalues_k,json_string((const char *) ((oph_json_obj_tree *) json->response[i].objcontent)[j].nodevalues[k][q]))) {
					...
					// NODELINKS
					if (((oph_json_obj_tree *) json->response[i].objcontent)[j].nodevalues_num1 != 0 && ((oph_json_obj_tree *) json->response[i].objcontent)[j].nodevalues_num1 != ((oph_json_obj_tree *) json->response[i].objcontent)[j].nodelinks_num) {
					...
					for (k = 0; k < ((oph_json_obj_tree *) json->response[i].objcontent)[j].nodelinks_num; k++) {
						...
						for (q = 0; q < ((oph_json_obj_tree *) json->response[i].objcontent)[j].nodelinks[k].links_num; q++) {
							...
							if (json_object_set_new(nodelinks_kq,"node",json_string((const char *) ((oph_json_obj_tree *) json->response[i].objcontent)[j].nodelinks[k].links[q].node))) {
							...
							if (((oph_json_obj_tree *) json->response[i].objcontent)[j].nodelinks[k].links[q].description) {
								if (json_object_set_new(nodelinks_kq,"description",json_string((const char *) ((oph_json_obj_tree *) json->response[i].objcontent)[j].nodelinks[k].links[q].description))) {
									pmesg_safe(flag, LOG_ERROR, __FILE__, __LINE__, OPH_JSON_LOG_MEMORY_ERROR, "description");
									if (oph_json) json_decref(oph_json);
									return OPH_JSON_MEMORY_ERROR;
								}
				...
				for (j = 0; j < json->response[i].objcontent_num; j++) {
					...
					if (((oph_json_obj_graph *) json->response[i].objcontent)[j].nodekeys_num != 0) {
						...
						for (k = 0; k < ((oph_json_obj_graph *) json->response[i].objcontent)[j].nodevalues_num1; k++) {
							...
							for (q = 0; q < ((oph_json_obj_graph *) json->response[i].objcontent)[j].nodevalues_num2; q++) {
								if (json_array_append_new(nodevalues_k,json_string((const char *) ((oph_json_obj_graph *) json->response[i].objcontent)[j].nodevalues[k][q]))) {
									pmesg_safe(flag, LOG_ERROR, __FILE__, __LINE__, OPH_JSON_LOG_MEMORY_ERROR, "nodevalue_k");
									if (oph_json) json_decref(oph_json);
									return OPH_JSON_MEMORY_ERROR;
								}
					...
					// NODELINKS
					if (((oph_json_obj_graph *) json->response[i].objcontent)[j].nodevalues_num1 != 0 && ((oph_json_obj_graph *) json->response[i].objcontent)[j].nodevalues_num1 != ((oph_json_obj_graph *) json->response[i].objcontent)[j].nodelinks_num) {
						pmesg_safe(flag, LOG_ERROR, __FILE__, __LINE__, OPH_JSON_LOG_BAD_PARAM_ERROR, "nodevalues_num1/nodelinks_num");
						if (oph_json) json_decref(oph_json);
						return OPH_JSON_BAD_PARAM_ERROR;
					}
					...
					for (k = 0; k < ((oph_json_obj_graph *) json->response[i].objcontent)[j].nodelinks_num; k++) {
						...
						for (q = 0; q < ((oph_json_obj_graph *) json->response[i].objcontent)[j].nodelinks[k].links_num; q++) {
							...
							if (json_object_set_new(nodelinks_kq,"node",json_string((const char *) ((oph_json_obj_graph *) json->response[i].objcontent)[j].nodelinks[k].links[q].node))) {
								pmesg_safe(flag, LOG_ERROR, __FILE__, __LINE__, OPH_JSON_LOG_MEMORY_ERROR, "node");
								if (oph_json) json_decref(oph_json);
								return OPH_JSON_MEMORY_ERROR;
							}
							...
							if (((oph_json_obj_graph *) json->response[i].objcontent)[j].nodelinks[k].links[q].description) {
								if (json_object_set_new(nodelinks_kq,"description",json_string((const char *) ((oph_json_obj_graph *) json->response[i].objcontent)[j].nodelinks[k].links[q].description))) {
									pmesg_safe(flag, LOG_ERROR, __FILE__, __LINE__, OPH_JSON_LOG_MEMORY_ERROR, "description");
									if (oph_json) json_decref(oph_json);
									return OPH_JSON_MEMORY_ERROR;
								}
...
int oph_json_to_json_string(oph_json *json, char **jstring) { return _oph_json_to_json_string(json, jstring, &global_flag); }
int oph_json_to_json_string_unsafe(oph_json *json, char **jstring) { return _oph_json_to_json_string(json, jstring, NULL); }
...
int oph_json_to_json_file(oph_json *json, char *filename) { return _oph_json_to_json_file(json, filename, &global_flag); }
int oph_json_to_json_file_unsafe(oph_json *json, char *filename) { return _oph_json_to_json_file(json, filename, NULL); }

int _oph_write_json(oph_json *oper_json, pthread_mutex_t* flag)
{
	if (!oper_json) return OPH_JSON_BAD_PARAM_ERROR;
...
int oph_write_json(oph_json *oper_json) { return _oph_write_json(oper_json, &global_flag); }
int oph_write_json_unsafe(oph_json *oper_json) { return _oph_write_json(oper_json, NULL); }

int _oph_write_and_get_json(oph_json *oper_json, char** jstring, pthread_mutex_t* flag)
{
	if (!oper_json || !jstring) return OPH_JSON_BAD_PARAM_ERROR;
...
int oph_write_and_get_json(oph_json *oper_json, char** jstring) { return _oph_write_and_get_json(oper_json, jstring, &global_flag); }
int oph_write_and_get_json_unsafe(oph_json *oper_json, char** jstring)  { return _oph_write_and_get_json(oper_json, jstring, NULL); }
...
int oph_json_add_responseKey(oph_json *json, const char *responseKey) { return _oph_json_add_responseKey(json, responseKey, &global_flag); }
int oph_json_add_responseKey_unsafe(oph_json *json, const char *responseKey) { return _oph_json_add_responseKey(json, responseKey, NULL); }
...
int oph_json_free_consumers(oph_json *json) { return _oph_json_free_consumers(json, &global_flag); }
int oph_json_free_consumers_unsafe(oph_json *json) { return _oph_json_free_consumers(json, NULL); }
...
int oph_json_free_responseKeyset(oph_json *json) { return _oph_json_free_responseKeyset(json, &global_flag); }
int oph_json_free_responseKeyset_unsafe(oph_json *json) { return _oph_json_free_responseKeyset(json, NULL); }
...
int oph_json_free_source(oph_json *json) { return _oph_json_free_source(json, &global_flag); }
int oph_json_free_source_unsafe(oph_json *json) { return _oph_json_free_source(json, NULL); }
...
int oph_json_free_response(oph_json *json) { return _oph_json_free_response(json, &global_flag); }
int oph_json_free_response_unsafe(oph_json *json) { return _oph_json_free_response(json, NULL); }
...
int oph_json_alloc(oph_json **json) { return _oph_json_alloc(json, &global_flag); }
int oph_json_alloc_unsafe(oph_json **json) { return _oph_json_alloc(json, NULL); }
...
int oph_json_free(oph_json *json) { return _oph_json_free(json, &global_flag); }
int oph_json_free_unsafe(oph_json *json) { return _oph_json_free(json, NULL); }
...
int oph_json_add_consumer(oph_json *json, const char *consumer) { return _oph_json_add_consumer(json, consumer, &global_flag); }
int oph_json_add_consumer_unsafe(oph_json *json, const char *consumer) { return _oph_json_add_consumer(json, consumer, NULL); }
...
int oph_json_set_source(oph_json *json, const char *srckey, const char *srcname, const char *srcurl, const char *description, const char *producer) { return _oph_json_set_source(json, srckey, srcname, srcurl, description, producer, &global_flag); }
int oph_json_set_source_unsafe(oph_json *json, const char *srckey, const char *srcname, const char *srcurl, const char *description, const char *producer) { return _oph_json_set_source(json, srckey, srcname, srcurl, description, producer, NULL); }
...
int oph_json_add_source_detail(oph_json *json, const char *key, const char *value) { return _oph_json_add_source_detail(json, key, value, &global_flag); }
int oph_json_add_source_detail_unsafe(oph_json *json, const char *key, const char *value) { return _oph_json_add_source_detail(json, key, value, NULL); }

int oph_json_is_objkey_printable(char **objkeys,int objkeys_num,const char *objkey) {
	if (objkeys_num<1 || !objkeys || !objkey) return 1;
	if (!strcmp(objkeys[0],"all")) return 1;
	if (!strcmp(objkeys[0],"none")) return 0;
	int i;
	for (i = 0; i < objkeys_num; i++) {
		if (!strcmp(objkeys[i],objkey)) return 1;
	}
	return 0;
}
...
{
	if (!jstring || !json) return OPH_JSON_BAD_PARAM_ERROR;
	*json = NULL;

	// ALLOC OPH_JSON
	if (_oph_json_alloc(json,flag)) return OPH_JSON_MEMORY_ERROR;
				...
				if (!strcmp(objclass,OPH_JSON_TEXT)) { //OBJCLASS TEXT
					...
					for (index2 = 0; index2 < json_array_size(objcontent); index2++) {
						...
						if (objcontentfrag) {
							...
							json_unpack(objcontentfrag,"{s?s,s?s,s?o,s?o}","title",&title,"description",&description,"rowkeys",&rowkeys,"rowfieldtypes",&rowfieldtypes);
							...
							// add grid
							if (_oph_json_add_grid(*json,(const char *)objkey,(const char *)title,(const char *)description,keys,(int)keys_num,fieldtypes,(int)fieldtypes_num,flag)) {
								if (keys) free(keys);
								if (fieldtypes) free(fieldtypes);
								if (jansson) json_decref(jansson);
								return OPH_JSON_GENERIC_ERROR;
					...
					for (index2 = 0; index2 < json_array_size(objcontent); index2++) {
						...
						if (objcontentfrag) {
							char *title=NULL,*description=NULL,**row_keys=NULL,**row_fieldtypes=NULL,**col_keys=NULL,**col_fieldtypes=NULL,***col_values=NULL,*measurename=NULL,*measuretype=NULL;
							...
							json_unpack(objcontentfrag,"{s?s,s?s,s?o,s?o,s?o,s?o,s?o,s?s,s?s}","title",&title,"description",&description,"rowkeys",&rowkeys,"rowfieldtypes",&rowfieldtypes,"colkeys",&colkeys,"colfieldtypes",&colfieldtypes,"colvalues",&colvalues,"measurename",&measurename,"measuretype",&measuretype);
							...
							if (!col_keys) {
								if (row_keys) free(row_keys);
								if (row_fieldtypes) free(row_fieldtypes);
								if (jansson) json_decref(jansson);
								return OPH_JSON_MEMORY_ERROR;
							}
							...
							for (index3 = 0; index3 < row_keys_num; index3++) {
								...
								if (!row_keys[index3]) {
									...
									if (row_fieldtypes) free(row_fieldtypes);
									if (col_keys) free(col_keys);
									if (col_fieldtypes) free(col_fieldtypes);
									if (jansson) json_decref(jansson);
									return OPH_JSON_GENERIC_ERROR;
								}
							}
							...
							for (q = 0; q < col_values_num; q++) {
								...
								if (colvalues_i) {
									...
									if (!col_values[q]) {
										int n;
										for (n = 0; n < q; n++) {
											if (col_values[n]) free(col_values[n]);
										}
										if (col_values) free(col_values);
										if (row_keys) free(row_keys);
										if (row_fieldtypes) free(row_fieldtypes);
										if (col_keys) free(col_keys);
										if (col_fieldtypes) free(col_fieldtypes);
							...
							// add multigrid
							if (_oph_json_add_multigrid(*json,(const char *)objkey,(const char *)title,(const char *)description,row_keys,(int)row_keys_num,row_fieldtypes,(int)row_fieldtypes_num,col_keys,(int)col_keys_num,col_fieldtypes,(int)col_fieldtypes_num,col_values,(int)col_values_num,(const char *)measurename,(const char *)measuretype,flag)) {
								if (row_keys) free(row_keys);
								if (row_fieldtypes) free(row_fieldtypes);
								if (col_keys) free(col_keys);
								if (col_fieldtypes) free(col_fieldtypes);
								if (col_values) {
									...
									for (ii = 0; ii < col_values_num; ii++) {
										if (col_values[ii]) free(col_values[ii]);
									}
									free(col_values);
								}
								if (jansson) json_decref(jansson);
									...
									if (rowvalues_i && measurevalues_i) {
										...
										for (index5 = 0; index5 < json_array_size(rowvalues_i); index5++) {
											...
											if (!row_values[index5]) {
												if (row_values) free(row_values);
												if (measure_values) free(measure_values);
												if (jansson) json_decref(jansson);
												return OPH_JSON_GENERIC_ERROR;
											}
										}
					...
					for (index2 = 0; index2 < json_array_size(objcontent); index2++) {
						...
						if (objcontentfrag) {
							...
							if (nodekeys) {
								...
								// add tree
								if (_oph_json_add_tree(*json,(const char *)objkey,(const char *)title,(const char *)description,node_keys,(int)node_keys_num,flag)) {
									if (node_keys) free(node_keys);
									if (jansson) json_decref(jansson);
									return OPH_JSON_GENERIC_ERROR;
								}
										...
										if (nodevalues_i) {
											...
											for (index5 = 0; index5 < json_array_size(nodevalues_i); index5++) {
												...
												if (!node_values[index5]) {
													if (node_values) free(node_values);
													if (jansson) json_decref(jansson);
													return OPH_JSON_GENERIC_ERROR;
												}
											}
									...
									for (sourcenode = 0; sourcenode < nodelinks_num; sourcenode++) {
										...
										if (nodelinks_i) {
											...
											for (s = 0; s < json_array_size(nodelinks_i); s++) {
												...
												if (_oph_json_add_tree_link(*json,(const char *)objkey,sourcenode,(int)strtol(targetnode,NULL,10),(const char *)linkdescription,flag)) {
													if (jansson) json_decref(jansson);
													return OPH_JSON_GENERIC_ERROR;
												}
											}
					...
					for (index2 = 0; index2 < json_array_size(objcontent); index2++) {
						...
						if (objcontentfrag) {
							...
							if (nodekeys) {
								...
								// add graph
								if (_oph_json_add_graph(*json,(const char *)objkey,is_digraph,(const char *)title,(const char *)description,node_keys,(int)node_keys_num,flag)) {
									if (node_keys) free(node_keys);
									if (jansson) json_decref(jansson);
									return OPH_JSON_GENERIC_ERROR;
								}
									...
									for (sourcenode = 0; sourcenode < nodelinks_num; sourcenode++) {
										...
										if (nodelinks_i) {
											...
											for (s = 0; s < json_array_size(nodelinks_i); s++) {
												...
												if (_oph_json_add_graph_link(*json,(const char *)objkey,sourcenode,(int)strtol(targetnode,NULL,10),(const char *)linkdescription,flag)) {
													if (jansson) json_decref(jansson);
													return OPH_JSON_GENERIC_ERROR;
												}
											}
...
int oph_json_from_json_string(oph_json **json, const char *jstring) { return _oph_json_from_json_string(json, jstring, &global_flag); }
int oph_json_from_json_string_unsafe(oph_json **json, const char *jstring) { return _oph_json_from_json_string(json, jstring, NULL); }
